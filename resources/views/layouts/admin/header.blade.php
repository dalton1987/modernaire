...
<header class="topbar" style="background: #fff;">
    <div Class="container">
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            <!-- Logo -->
            <!-- ============================================================== -->
            <div class="navbar-header" style="width: auto;"><a class="navbar-brand" href="{{url('/')}}">
                    <!-- Logo icon -->
                    <b>
                        <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->

                        <!-- Dark Logo icon -->
                        <img src="{{asset($logo->img_path)}}" style=" width: 100px; height: 70px; object-fit: contain; " alt="homepage" class="dark-logo"/>
                        
                        <!-- Light Logo icon -->
                        <img src="{{asset($logo->img_path)}}" style=" width: 100px; height: 70px; object-fit: contain; " alt="homepage" class="light-logo"/> </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span>
          <!-- dark Logo text -->

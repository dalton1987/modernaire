            ...
            <nav class="sidebar-nav ">
                <ul id="sidebarnav">
                    <li class="clearfix"></li>
                        ...
                        <li class=""><a class="has-arrow waves-effect waves-dark" href="{{url('dashboard')}}" aria-expanded="false"><i class="flaticon-desktop-computer-screen-with-rising-graph"></i>
                            ...
                            <ul aria-expanded="false" class="collapse">
								...
								<!-- website_color -->
                                <li><a href="{{ route('website_color') }}" class="">Website Color</a></li>
                                <!-- website_color -->
                                ...
                                <li><a href="{{url('admin/inner-banner')}}" class="">Inner Banners</a></li>
                        ...
                        <li>
                            ...
                            <li><a href="{{url('admin/newsletter/inquiries')}}" class="">Newsletter Emails</a></li>
                            </ul>
                        </li>
                    ...
                    <li><hr></li>
                        ...
                        <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{url('admin/attribute')}}">Custom Attributes</a></li>
                                <li><a href="{{url('admin/product')}}">Products</a></li>

                                 <li><a href="{{url('admin/order/list')}}">Orders</a></li>  


                                <!-- <li><a href="{{url('admin/custom-price')}}">Custom Price</a></li> -->
                    ...
                    <li><hr></li>
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="{{url('dashboard')}}" aria-expanded="false"><i class="fas fa-images"></i>
                            <span class="hide-menu">Photo Gallery</span></a>
                            <ul aria-expanded="false" class="collapse">
                            <li><a href="{{url('admin/gallery-category')}}" class="">Categories</a></li>
                            <li><a href="{{url('admin/gallery')}}" class="">Images</a></li>
                            </ul>
                        </li>
                        
                        <li><hr></li>
                        <!--{"title":"GalleryCategory","icon":"fas fa-images","url":"\/admin\/gallery-category"}-->
                        <!--{"title":"Gallery","icon":"far fa-images","url":"\/admin\/gallery"}-->
                        
<!--{"title":"Location","icon":"fas fa-map-marker","url":"\/admin\/representative-location"}-->
                   <!--  <li>

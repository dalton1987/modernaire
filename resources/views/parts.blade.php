...
<!-- ============================================================== -->
    ...
    <!-- Prtoducts -->
    <section class="productsec parts-product_page product-page-sec">
        <div class="container">
            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <ul class="product-cart-icon d-flex">
                                                <li> <a href="https://demo-customlinks.com/modernaire/cart"><i class="fal fa-shopping-cart" aria-hidden="true"></i></a></li>

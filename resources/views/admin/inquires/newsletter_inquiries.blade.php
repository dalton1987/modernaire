                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex m-b-10 no-block">
                            <h5 class="card-title m-b-0 align-self-center">Newsletter Submissions</h5>
                            ...
                            <table id="myTable" class="table color-table table-bordered product-table table-hover">
								...
								@foreach($newsletter_inquiries as $item)	
									...
									<td class="text-center">
                                            ...
                                            <a onclick="alert('Are you sure you want to delete?')" href="{{ url('/admin/newsletter/inquiries/delete',$item->id) }}"
                                               title="Delete Email">

    ...
    <div class="container-fluid bg-white mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <h3 class="box-title pull-left">Size</h3>
                    
                        <a class="btn btn-success pull-right" href="{{ url('/admin/size/create') }}"><i
                                    class="icon-plus"></i> Add Size</a>
                            ...
                            @foreach($size as $item)
                                <tr class="text-center">
                                    ...
                                    <td>
                                            ...
                                            <a href="{{ url('/admin/size/' . $item->id . '/edit') }}"
                                               title="Edit Size">
                                                <button class="btn btn-primary btn-sm">

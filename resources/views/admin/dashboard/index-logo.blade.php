          ...
          <div class="card-body">
            ...
            <div class="row m-b-15">
              <div class="col-lg-4 col-md-4">
                <h3>Header Logo</h3>
                <img style="width: 100%; background-color: #0303!important;" alt="" id="input-preview" src="{{isset($logo)?asset($logo->img_path):asset('images/upload.jpg') }}">
            ...
            <!-- <div class="row m-b-15">
              <div class="col-lg-4 col-md-4">
                <h3>Footer Logo</h3>
                <img style="width: 100%;" alt="" id="input-preview" src="{{ isset($footer_logo)?asset($footer_logo->img_path):asset('images/upload.jpg') }}">
                <div class="upload-photo">
                  <input type="file" name="footer_image" id="input-file-now" class="dropify" />
                </div>
              </div>
            </div> -->

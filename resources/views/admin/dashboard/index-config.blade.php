                                ...
                                <div class="form-wrap form-wrap2 mt-4">
                                        ...
                                        <div class="form-group m-b-15">
                                            ...
                                            @if($_Config->type='1')
                                                ...
                                                @if($_Config->flag_type == 'customer_service_email' || $_Config->flag_type == 'technical_information_email' || $_Config->flag_type == 'installation_email')
                                                <div class="col-sm-6 col-xs-6">
                                                    <div class="form-group m-b-15">
                                                        <label class="control-label text-primary font-12 m-b-5">{{$_Config->flag_show_text}} <span style="color: red;">*more than 1 email can be added with a comma</span></label>
                                                        <div>

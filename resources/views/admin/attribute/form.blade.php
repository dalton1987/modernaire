...
<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('attribute') ? 'has-error' : ''}}">
    {!! Form::label('attribute', 'Attribute', ['class' => 'col-md-12 control-label']) !!}
    <div class="col-md-12">
        {!! Form::text('attribute', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required', 'onkeyup'=>'generateSlug(this.value);'] : ['class' => 'form-control']) !!}
...
<!-- <div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('value') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        {!! Form::textarea('value', null, ('' == 'required') ? ['class' => 'form-control', 'id' => 'summary-ckeditor', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('is_active') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        <label for="is_active" class="col-md-12 control-label"><input type="checkbox" name="is_active" value="1" @if($attribute->is_active == '1') checked @endif > Active</label>

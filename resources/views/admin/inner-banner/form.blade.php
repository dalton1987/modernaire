<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('page') ? 'has-error' : ''}}">
    {!! Form::label('page', 'Page', ['class' => 'col-md-12 control-label']) !!}
    <div class="col-md-12">
        {!! Form::text('page', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required', 'readonly'=> 'readonly'] : ['class' => 'form-control']) !!}
...
<div class="form-group row justify-content-center left_css col-md-12 {{ $errors->has('title') ? 'has-error' : ''}}">
    ...
    <div class="col-md-12">
        ...
        src="{{ isset($innerbanner)?asset($innerbanner->image):asset('images/upload.jpg') }}" style=" width: 30%; "> 
        <br/>
      </div>
        <br/>

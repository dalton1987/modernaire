...
<div style=""> <!-- main Div -->
	...
	<div style="margin: 50px auto; color: #2a3342; border:7px solid #eee; ">
		...
		<h2 style="font-size: 16px; font-weight: inherit;">Hi, You have received a new inquiry for newsletter subscription from {{$array['name']}}. Below are the details:</h2>
		...
		<!-- <b><p style="font-size: 16px; font-weight: inherit;">You can also view the inquiry through the link given below.</p><b><br>

    ...
    <section class="build-hood-sec about-page-sec">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="build-hood-txt">
                        <div class="abt-hed">
                            <h5><?= html_entity_decode($cms16->title) ?> </h5>
                            <h3><?= html_entity_decode($cms16->sub_title) ?></h3>
                        </div>
                        <p><?= html_entity_decode($cms16->content) ?></p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="abt-txt">
                        <?= html_entity_decode($cms16->extra_content) ?>
                    </div>
                </div>
            </div>
